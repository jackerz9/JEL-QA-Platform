...
const { agentsRouter, categoriesRouter, contactsRouter, channelsRouter } = require('./routes/crud');
...
app.use('/api/channels', auth, requireRole('admin', 'supervisor'), channelsRouter);
